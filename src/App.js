      ...
      >
        ...
        <div className="intro-content display-table">
          <div className="table-cell">
            <div className="container">
              <h1 className="intro-title mb-4">Decentralised Demonstrations</h1>
              <p className="intro-subtitle">
                <span className="text-slider-items">
                  Blockchain based activisim,Powered by Ethereum,The future will
                  not be
                  ...
                  <div className="col-md-12">
                    <div className="about-me pt-4 pt-md-0">
                      ...
                      <p className="lead">
                        ...
                        anonymous financial contributions via cryptocurrency. By
                        using cryptocurrencies and the Ethereum blockchain, it
                        allows safe and secure socialisation of demonstrations.
                      </p>
                      <p className="lead">
                        The platform enables supporters and contributors of the
                        cause who could not otherwise participate, to donate
                        funds securely and anonymously without requiring third
                        party banks or payment gateways who can reverse
                        transactions or close accounts.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="service-box">
                ...
                <div className="service-content">
                  ...
                  <p className="s-description text-center">
                    Use ddemonstrate.org to co-ordinate your event in a safe and
                    secure way
                  </p>
                </div>
              </div>
              ...
              <div className="service-box">
                ...
                <div className="service-content">
                  ...
                  <p className="s-description text-center">
                    ...
                    selecting one below. Or if you wish to donate to the project
                    to help development costs: BTC
              ...
              <div className="service-box">
                ...
                <div className="service-content">
                  ...
                  <p className="s-description text-center">
                    ...
                    <ah href="https://www.poap.xyz">poap.xyz</ah> Developers can
                    ...
                    <div className="col-md-12">
                      ...
                      <div className="more-info">
                        <p className="lead">
                          ...
                          to us. Please contact us with your questions, comments
                          and recommendations, we look forward to hearing from
                          you.
                          <a href="publickey.ddemonstrate@protonmail.com-2.asc">
                            PGP Public Key
                          </a>
                          | Fingerprint 9ee37e66bac184e4cd13ce73a33304a5545027ca
                        </p>
